...
list_countries.setStyleSheet('border: 2px solid white; font-size 24px; color: white; font_style: italic; font-family: georgia')
text_countries.setStyleSheet('border: 2px solid white; font-size 24px; color: white; font_style: italic; font-family: georgia')
name_countries.setStyleSheet('border: 2px solid white; font-size 24px; color: white; font_style: italic; font-family: georgia')
add_country_button.setStyleSheet('border: 2px solid white; font-size 20px; color: white; font_style: italic; font-family: georgia')
del_country_button.setStyleSheet('border: 2px solid white; font-size 20px; color: white; font_style: italic; font-family: georgia')
edit_country_button.setStyleSheet('border: 2px solid white; font-size 20px; color: white; font_style: italic; font-family: georgia')
